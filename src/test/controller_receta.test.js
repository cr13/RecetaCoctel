...
describe("Función para obtener una receta por titulo", () => {
    test('se va volver añadir la receta borrada en el test anterior y se va a buscar la receta Mojito', () => {
        ...
        expect.assertions(listRecetas);
        listRecetas.addReceta(receta_uno);
        expect(listRecetas.getRecetaByTitle('Mojito')).toEqual({ "comensales": 5, "dificultad": "Fácil", "duracion": 10, "id_receta": 1, "ingredientes": [{ "descripcion": "100ml", "id_ing": 1, "nombre": "Ron Blanco", "recetas": undefined, "tipo": "bebida" }, { "descripcion": "200ml", "id_ing": 2, "nombre": "Seven UP", "recetas": undefined, "tipo": "bebida" }, { "descripcion": "1 o 2 cucharadas", "id_ing": 3, "nombre": "Azucar Morena", "recetas": undefined, "tipo": "Hidratos de carbono" }], "instrucciones": "Tritura las hojas de menta con el azúcar y el zumo de lima. Agrega un chorrito de agua con gas y llena el vaso con hielo picado. Vierta el ron y cubra con agua con gas. Decore y sirva con pajita.", "titulo": "Mojito" });
